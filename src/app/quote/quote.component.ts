...
export class QuoteComponent implements OnInit {
    ...
    quotes = [
        new Quote(1, '“The Way Get Started Is To Quit Talking And Begin Doing.”','By James Mwai', 'Walt Disney',1, 2),
...
// tslint:disable-next-line: max-line-length
        ...
        new Quote(5,'Coding is the epitome if fun', 'Virginia X', 'Admin', 0, 0),
        // tslint:disable-next-line: max-line-length
